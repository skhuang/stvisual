(() => {
  ...
  function parseNodesText(nodesText) {
    ...
    return rows.map((row, index) => {
      const [id, label, x2, y] = row.split(",").map((item) => item.trim());
      if (!id || !label || x2 === void 0 || y === void 0) {
        throw new Error(`\u7BC0\u9EDE\u683C\u5F0F\u932F\u8AA4\uFF08\u7B2C ${index + 1} \u884C\uFF09\uFF0C\u8ACB\u4F7F\u7528 id,label,x,y\u3002`);
      }
      const parsedX = Number(x2);
...
--${boundary}--`;
  ...
  function createCloudIntegrationClient() {
    ...
    return {
      ...
      async uploadFileToDrive(file, options = {}) {
        ...
        if (!response.ok) {
          throw new Error(((_a = payload == null ? void 0 : payload.error) == null ? void 0 : _a.message) || "\u4E0A\u50B3\u5230 Google Drive \u5931\u6557\u3002");
        }
        return payload;
      }
    };
  ...
  function createCloudStoragePanel() {
    ...
    let user = null;
    let status = client.isConfigured ? "\u8ACB\u5148\u4EE5 Google \u767B\u5165\u5F8C\uFF0C\u518D\u5132\u5B58\u8A2D\u5B9A\u6216\u4E0A\u50B3\u6A94\u6848\u3002" : `Firebase \u8A2D\u5B9A\u4E0D\u5B8C\u6574\uFF1A${client.missingKeys.join(", ")}`;
      ...
      <div class="cloud-card">
        <div class="cloud-header">
          ...
          <div class="cloud-auth-actions">
            <button type="button" class="cloud-btn" data-testid="cloud-signin-btn" ${!client.isConfigured ? "disabled" : ""}>Google \u767B\u5165</button>
